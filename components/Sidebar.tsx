...
const sidebarData: { title: string; icon: LucideIcon; items: { title: string; path: string }[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: 'devforge jenkins setup', path: '/docs/commands#jenkins-setup' },
      { title: 'devforge diagnose', path: '/docs/commands#diagnose' },
      { title: 'devforge agent status', path: '/docs/commands#agent-status' },
      { title: 'devforge agent reset', path: '/docs/commands#agent-reset' },
      { title: 'devforge agent graph status', path: '/docs/commands#agent-graph-status' },
      { title: 'devforge agent graph reset', path: '/docs/commands#agent-graph-reset' },
      { title: 'devforge cache clear', path: '/docs/commands#cache-clear' },
      { title: 'devforge cache stats', path: '/docs/commands#cache-stats' },
      { title: 'devforge cache test-elasticache', path: '/docs/commands#cache-test-elasticache' },
      { title: 'devforge memory:stats', path: '/docs/commands#memory-stats' },
