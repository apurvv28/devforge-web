...
const searchData = [
  ...
  { title: 'devforge jenkins setup', path: '/docs/commands#jenkins-setup', section: 'Commands' },
  { title: 'devforge diagnose', path: '/docs/commands#diagnose', section: 'Commands' },
  { title: 'devforge agent status', path: '/docs/commands#agent-status', section: 'Commands' },
  { title: 'devforge agent reset', path: '/docs/commands#agent-reset', section: 'Commands' },
  { title: 'devforge agent graph status', path: '/docs/commands#agent-graph-status', section: 'Commands' },
  { title: 'devforge agent graph reset', path: '/docs/commands#agent-graph-reset', section: 'Commands' },
  { title: 'devforge cache clear', path: '/docs/commands#cache-clear', section: 'Commands' },
  { title: 'devforge cache stats', path: '/docs/commands#cache-stats', section: 'Commands' },
  { title: 'devforge cache test-elasticache', path: '/docs/commands#cache-test-elasticache', section: 'Commands' },
  { title: 'devforge memory:stats', path: '/docs/commands#memory-stats', section: 'Commands' },
